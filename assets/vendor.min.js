...
function viewButtons(t, e) {
  ...
  switch (t) {
      ...
      case "getButtonHtml":
          ...
          var f = "" != s ? "<li" + i + ">" + d + '<a href="#" class="options-color' + r + '" data-value="' + o + '" data-tooltip="' + o + '" ' + s + "></a></li>" : "<li" + i + '><a id="boldSelector" href="#" data-value=' + p + ` onclick="attachBoldSelector(event)" ontouchstart="attachBoldSelector(event)" >` + o + "</a></li>";
...
SwatchesConstructor.prototype.destroy = function() {
  ...
  e.enableHistoryState && history.pushState(null, null, location.pathname + "?variant=" + n.id), e.createSwatches(n.id), $(e.contentParent).closest(".tt-product-single-info").find(".input_variant").val(n.id);
    //window.location.reload(); Not Sure Why 
